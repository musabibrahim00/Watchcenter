...
export function SlackConfigForm({ step, onUpdate }: StepConfigurationFormProps) {
  return (
    <>
      <AISuggestionBox
...
export function CreateCaseConfigForm({ step, onUpdate }: StepConfigurationFormProps) {
  return (
    <>
      <AISuggestionBox
...
export function AlertTriggerConfigForm({ step, onUpdate }: StepConfigurationFormProps) {
...
export function VulnerabilityDetectedTriggerForm({ step, onUpdate }: StepConfigurationFormProps) {
  const [config, setConfig] = useState({
...
export function AssetDiscoveredTriggerForm({ step, onUpdate }: StepConfigurationFormProps) {
  const [config, setConfig] = useState({
...
export function CaseCreatedTriggerForm({ step, onUpdate }: StepConfigurationFormProps) {
  const [config, setConfig] = useState({
...
export function ScheduledTriggerForm({ step, onUpdate }: StepConfigurationFormProps) {
  const [config, setConfig] = useState({
    schedule: "daily",
    time: "08:00",
    timezone: "UTC",
...
export function ManualTriggerForm({ step, onUpdate }: StepConfigurationFormProps) {
  const [config, setConfig] = useState({
...
export function NotificationConfigForm({ step, onUpdate }: StepConfigurationFormProps) {
  return (
    <>
      <div>
        <label className="text-[11px] mb-[6px] block" style={{ color: colors.textMuted, fontWeight: 500 }}>
...
export function JiraConfigForm({ step, onUpdate }: StepConfigurationFormProps) {
  return (
    <>
      <div>
        <label className="text-[11px] mb-[6px] block" style={{ color: colors.textMuted, fontWeight: 500 }}>
...
export function GitHubConfigForm({ step, onUpdate }: StepConfigurationFormProps) {
  return (
    <>
      <div>
        <label className="text-[11px] mb-[6px] block" style={{ color: colors.textMuted, fontWeight: 500 }}>
...
export function ConditionConfigForm({ step, onUpdate }: StepConfigurationFormProps) {
  return (
    <>
      <div>
        <label className="text-[11px] mb-[6px] block" style={{ color: colors.textMuted, fontWeight: 500 }}>
...
export function AIEnrichmentConfigForm({ step, onUpdate }: StepConfigurationFormProps) {
  return (
    <>
      <div>
        <label className="text-[11px] mb-[6px] block" style={{ color: colors.textMuted, fontWeight: 500 }}>
...
export function UpdateAssetConfigForm({ step, onUpdate }: StepConfigurationFormProps) {
  return (
    <>
      <div>
        <label className="text-[11px] mb-[6px] block" style={{ color: colors.textMuted, fontWeight: 500 }}>
...
export function TagResourceConfigForm({ step, onUpdate }: StepConfigurationFormProps) {
  return (
    <>
      <div>
        <label className="text-[11px] mb-[6px] block" style={{ color: colors.textMuted, fontWeight: 500 }}>
...
export function GenericConfigForm({ step, onUpdate }: StepConfigurationFormProps) {
  return (
    <div
