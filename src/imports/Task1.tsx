  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[4px] items-start leading-[normal] not-italic relative text-[10px] w-full">
        ...
        <p className="relative shrink-0 text-[#89949e]">{`Production TLS expiry < 72h — external-facing services affected`}</p>
      </div>
    </div>
  );
}
...
export default function Task() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start p-[17px] relative rounded-[12px] size-full" data-name="Task1">
