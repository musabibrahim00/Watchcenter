...
const TASKS = [
  ...
  "Validating auth boundaries",
  "Reviewing SAST findings",
  "Checking injection vectors",
  "Evaluating CORS policies",
...
export default function ApplicationSecurityAnalyst() {
  ...
  return (
    <div
      ...
      data-name="Application Security Analyst"
    >
      <div className="content-stretch flex font-['Inter:Medium',sans-serif] font-medium items-center justify-between leading-[normal] not-italic relative shrink-0 text-[12px] text-center w-full">
        <p className="relative shrink-0 text-[#dadfe3]">AppSec Analyst</p>
