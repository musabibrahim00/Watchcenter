...
const TASKS = [
  "Correlating exploit telemetry",
  "Triaging inbound alert cluster",
  "Mapping incident timeline",
  "Updating risk score",
  "Evaluating exploit maturity",
  "Scanning SIEM correlation rules",
  "Aggregating IOC signals",
...
export default function SocAnalyst() {
  ...
  return (
    <div
      ...
      data-name="Asset Intelligence Analyst"
    >
      <div className="content-stretch flex font-['Inter:Medium',sans-serif] font-medium items-center justify-between leading-[normal] not-italic relative shrink-0 text-[12px] text-center w-full">
        <p className="relative shrink-0 text-[#dadfe3]">Asset Intelligence Analyst</p>
