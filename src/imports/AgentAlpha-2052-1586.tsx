import svgPaths from "./svg-jjrcrkk6uy";
  ...
  return (
    <div className="absolute inset-[8.33%_0]" data-name="Alpha">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 23.3334">
        <g id="Alpha">
          <g id="Group 8">
            <path d={svgPaths.p1413e080} fill="url(#paint0_linear_2052_1403)" id="Vector" />
            <path d={svgPaths.p224a4440} fill="url(#paint1_linear_2052_1403)" id="Vector_2" />
          </g>
          <path d={svgPaths.p3b453f40} fill="url(#paint2_linear_2052_1403)" id="Vector_3" stroke="var(--stroke-0, #121E27)" />
          <g id="Vector_4">
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2052_1403" x1="13.9979" x2="13.9979" y1="8.16667" y2="19.8334">
            <stop stopColor="#3E4E5A" />
            <stop offset="1" stopColor="#1E2A34" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_2052_1403" x1="13.9982" x2="13.9982" y1="4.66667" y2="23.3334">
            <stop stopColor="#3E4E5A" />
            <stop offset="1" stopColor="#1E2A34" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_2052_1403" x1="14" x2="14" y1="8.16667" y2="19.8334">
...
function Container() {
  return (
    <div className="absolute bg-[#050b11] content-stretch flex items-center left-[8px] p-[20px] rounded-[34px] top-[8px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#0781c2] border-solid inset-0 pointer-events-none rounded-[34px] shadow-[0px_0px_4.484px_0px_rgba(137,148,158,0.04)]" />
      <Icon />
    </div>
  );
}
...
export default function AgentAlpha() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-center relative size-full" data-name="AgentAlpha">
      <Frame />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#89949e] text-[12px] text-center w-[96px] whitespace-pre-wrap">Application Security Analyst</p>
    </div>
  );
}