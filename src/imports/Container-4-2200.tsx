...
export default function Container() {
  return (
    <div className="content-stretch flex gap-[20px] items-start p-[17px] relative rounded-[12px] size-full" data-name="Container" style={{ backgroundImage: "linear-gradient(38.7326deg, rgba(5, 11, 17, 0) 73.614%, rgba(255, 87, 87, 0.24) 100%)" }}>
