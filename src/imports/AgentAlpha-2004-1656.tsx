import svgPaths from "./svg-mrwps8d4ec";
...
export default function AgentAlpha() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-center relative size-full" data-name="AgentAlpha">
      <Frame />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#89949e] text-[12px] text-center w-full whitespace-pre-wrap">Alpha</p>
    </div>
  );
}